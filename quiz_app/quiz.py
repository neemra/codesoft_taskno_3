...
question_label = tk.Label(frame,height=5, width=28,bg='#900c3f',fg="#fff", 
                          font=('Time New Roman', 20),wraplength=500)
...
option1 = tk.Radiobutton(frame, bg="#fff", variable=v1, font=('Time New Roman ', 20),
                         command = lambda : checkAnswer(option1))
option2 = tk.Radiobutton(frame, bg="#fff", variable=v2, font=('Time New Roman ', 20), 
                         command = lambda : checkAnswer(option2))
option3 = tk.Radiobutton(frame, bg="#fff", variable=v3, font=('Time New Roman ', 20), 
                         command = lambda : checkAnswer(option3))
option4 = tk.Radiobutton(frame, bg="#fff", variable=v4, font=('Time RomanNew ', 20), 
                         command = lambda : checkAnswer(option4))

button_next = tk.Button(frame, text='Next',bg='#F8B195', font=('Time New Roman ', 20), 
